...
# 2. Run CSIRO EfficientNet-B0 Binary Classification
python train_csiro.py
```
> See [`README_CSIRO.md`](file:///c:/Users/karth/OneDrive/Desktop/SIH/README_CSIRO.md) for detailed dataset overview, metric explanations for judges, and output specifications.
...
<a href="https://pytorch.org/"><img src="https://img.shields.io/badge/python-v3.6+-blue.svg?logo=python&style=for-the-badge" /></a>
